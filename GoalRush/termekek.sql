...
INSERT INTO focilabdak (marka, nev, ar, leiras, raktaron) VALUES
('Adidas', 'Al Rihla Pro', 29999, 'A 2022-es világbajnokság hivatalos labdája.', 8700),
('Adidas', 'Telstar 18', 25999, 'A 2018-as világbajnokság hivatalos labdája.', 7520),
('Adidas', 'FIFA Pro Ball', 21999, 'FIFA által hitelesített profi labda.', 6890),
('Adidas', 'Tango España', 18999, 'Régi klasszikus újratervezve.', 7120),
('Adidas', 'UCL Pro Istanbul', 27999, 'Bajnokok Ligája hivatalos labdája.', 7800),
('Adidas', 'Uniforia League', 19999, 'EURO 2020 hivatalos labdája.', 7310),
('Adidas', 'Conext 21', 20999, 'Nemzetközi meccsekhez tervezve.', 8000),
('Adidas', 'Finale 21 Pro', 24999, 'UCL döntő hivatalos labdája.', 7600),
('Adidas', 'Predator Training Ball', 9999, 'Kiváló edzéslabda.', 11200),
('Adidas', 'X Speedportal Ball', 10999, 'Modern design gyakorláshoz.', 8900),
('Nike', 'Flight Ball', 26999, 'Premier League hivatalos labdája.', 8340),
('Nike', 'Merlin Serie A', 23999, 'Serie A hivatalos labdája.', 7010),
('Nike', 'Strike Ball', 14999, 'Megbízható edzéslabda.', 11300),
('Nike', 'Academy Team', 12999, 'Tartós és sokoldalú labda.', 12800),
('Nike', 'Pitch Team Ball', 9999, 'Jól látható színekkel.', 10400),
('Nike', 'Premier League Flight', 27999, 'Profik által használt labda.', 9320),
('Nike', 'Phantom Skills Ball', 8999, 'Kisebb méret gyakorláshoz.', 7700),
('Nike', 'Park Soccer Ball', 10999, 'Alap edzőlabda.', 9600),
('Nike', 'Tiempo Legend Ball', 9999, 'Egyensúly és repülés kontroll.', 8200),
('Nike', 'Strike Team', 11999, 'Edzésekhez és amatőr meccsekhez.', 8700),
('Nike', 'Futsal Pro', 12999, 'Beltéri focihoz.', 6800),
('Nike', 'Futsal Maestro', 10999, 'Futsal specifikus.', 5900),
('Nike', 'Flight Euro 2024', 28999, '2024-es EB hivatalos labda.', 9200),
('Nike', 'Academy Futsal', 9999, 'Beltéri játékra optimalizált.', 6100),
('Nike', 'Zoom Ball', 11999, 'Gyorsaságra tervezve.', 7400);
